            ...
            <div className="relative flex size-full items-center justify-center">
                ...
                <div className="fixed bottom-0 flex w-full items-center justify-center gap-5">
                    ...
                    <div className="flex items-center">
                        <DropdownMenuTrigger className="cursor-pointer rounded-2x1 bg-[#19232d] px">
                        <LayoutList size={20} className="text-white"/>
                        </DropdownMenuTrigger>
                        </div> 
                        <DropdownMenuContent className="border-black text-white">
                        ...
                        <div className="cursor-pointer rounded-2x1 bg-[#19232d] px-4 py-2 hover:bg-gray">
