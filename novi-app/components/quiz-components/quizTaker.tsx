        ...
        <div className="flex flex-col h-full min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          ${isLow ? 'bg-red-100 text-red-600 animate-pulse' : 'bg-blue-50 text-blue-700'}`}>
            ...
            <div className="w-full h-1.5 bg-gray-100">
                <div className="h-full bg-gradient-to-r from-blue-500 to-indigo-500 transition-all duration-300"
                    style={{ width: `${progress}%` }} />
            </div>

            <div className="flex-1 flex flex-col lg:flex-row gap-6 max-w-5xl mx-auto w-full p-6">
                {/* Question area */}
                <div className="flex-1 flex flex-col gap-5">
                  ...
                  ${selected === oi ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-500'}`}>
                                ...
                                <span className={`font-medium text-base ${selected === oi ? 'text-blue-800' : 'text-gray-700'}`}>{opt}</span>
                            </button>
                        ))}
                    </div>
